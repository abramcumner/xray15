...
void CUITradeWnd::Init()
{
	...
	m_uidata->UICharacterInfoLeft.InitCharacterInfo(Fvector2().set(0,0), m_uidata->UIOurIcon.GetWndSize(), TRADE_CHARACTER_XML);
	m_uidata->UIOthersIcon.AttachChild	(&m_uidata->UICharacterInfoRight);
	m_uidata->UICharacterInfoRight.InitCharacterInfo(Fvector2().set(0,0), m_uidata->UIOthersIcon.GetWndSize(), TRADE_CHARACTER_XML);
	...
	m_uidata->UIItemInfo.InitItemInfo	(Fvector2().set(0,0), m_uidata->UIDescWnd.GetWndSize(), TRADE_ITEM_XML);
