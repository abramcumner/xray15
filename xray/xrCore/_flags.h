...
public:
	...
	IC 	SelfRef	or_		(const T mask)								{ flags|=mask;			return *this;	}
	IC 	SelfRef	or_		(const Self& f, const T mask) 				{ flags=f.flags|mask;	return *this;	}
	IC 	SelfRef	and_	(const T mask)								{ flags&=mask;			return *this;	}
	IC 	SelfRef	and_	(const Self& f, const T mask) 				{ flags=f.flags&mask;	return *this;	}
