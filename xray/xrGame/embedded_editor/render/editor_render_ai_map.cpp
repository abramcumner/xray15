...
static t_node_tc node_tc[16] = {
    { { 0.00f, 0.25f }, { 0.25f, 0.25f }, { 0.25f, 0.00f }, { 0.00f, 0.00f } },
    { { 0.25f, 0.25f }, { 0.50f, 0.25f }, { 0.50f, 0.00f }, { 0.25f, 0.00f } },
    { { 0.50f, 0.25f }, { 0.75f, 0.25f }, { 0.75f, 0.00f }, { 0.50f, 0.00f } },
    { { 0.75f, 0.25f }, { 1.00f, 0.25f }, { 1.00f, 0.00f }, { 0.75f, 0.00f } },

    { { 0.00f, 0.50f }, { 0.25f, 0.50f }, { 0.25f, 0.25f }, { 0.00f, 0.25f } },
    { { 0.25f, 0.50f }, { 0.50f, 0.50f }, { 0.50f, 0.25f }, { 0.25f, 0.25f } },
    { { 0.50f, 0.50f }, { 0.75f, 0.50f }, { 0.75f, 0.25f }, { 0.50f, 0.25f } },
    { { 0.75f, 0.50f }, { 1.00f, 0.50f }, { 1.00f, 0.25f }, { 0.75f, 0.25f } },

    { { 0.00f, 0.75f }, { 0.25f, 0.75f }, { 0.25f, 0.50f }, { 0.00f, 0.50f } },
    { { 0.25f, 0.75f }, { 0.50f, 0.75f }, { 0.50f, 0.50f }, { 0.25f, 0.50f } },
    { { 0.50f, 0.75f }, { 0.75f, 0.75f }, { 0.75f, 0.50f }, { 0.50f, 0.50f } },
    { { 0.75f, 0.75f }, { 1.00f, 0.75f }, { 1.00f, 0.50f }, { 0.75f, 0.50f } },

    { { 0.00f, 1.00f }, { 0.25f, 1.00f }, { 0.25f, 0.75f }, { 0.00f, 0.75f } },
    { { 0.25f, 1.00f }, { 0.50f, 1.00f }, { 0.50f, 0.75f }, { 0.25f, 0.75f } },
    { { 0.50f, 1.00f }, { 0.75f, 1.00f }, { 0.75f, 0.75f }, { 0.50f, 0.75f } },
    { { 0.75f, 1.00f }, { 1.00f, 1.00f }, { 1.00f, 0.75f }, { 0.75f, 0.75f } },
};
...
void renderAiMap()
{
    ...
    if (graph.valid_vertex_position(min_position))
        I = std::lower_bound(graph.begin(), graph.end(), graph.vertex_position(min_position).xz(),
            [](const auto& vertex, auto value) { return vertex.position().xz() < value; });
    else
        I = graph.begin();

    if (graph.valid_vertex_position(max_position)) {
        E = std::upper_bound(graph.begin(), graph.end(), graph.vertex_position(max_position).xz(),
            [](auto value, const auto& vertex) { return value < vertex.position().xz(); });
        if (E != graph.end())
            ++E;
    } else
        E = graph.end();
    ...
    u32 DvbSize = 1536 * 1024; // размер буфера rsDVB_Size from R_DStreams.cpp:12
    u32 PointSize = 24; // размер данных под одну точку hGeom_LIT.stride() from dxUIRender.cpp
    u32 PointCount = 6; // на одну аи-ноду требуется 2 треугольника = 6 точек
    ...
    for (; I != E; ++I) {
        ...
        int k = 0;
        if (graph.valid_vertex_id(N.link(0)))
            k |= 1 << 0;
        if (graph.valid_vertex_id(N.link(1)))
            k |= 1 << 1;
        if (graph.valid_vertex_id(N.link(2)))
            k |= 1 << 2;
        if (graph.valid_vertex_id(N.link(3)))
            k |= 1 << 3;
        // create vertices
