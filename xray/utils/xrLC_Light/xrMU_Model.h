...
private:
	...
	typedef  vector_serialize< t_read<_face> >		tread_faces;
	typedef  vector_serialize< t_write<_face> >		twrite_faces;

	typedef  vector_serialize< t_read<_vertex> >	tread_vertices;
	typedef  vector_serialize< t_write<_vertex> >	twrite_vertices;
...
typedef  vector_serialize< t_read<xrMU_Model> >		tread_models;
typedef  vector_serialize< t_write<xrMU_Model> >	twrite_models;
